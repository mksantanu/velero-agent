...
import { Resources, V1DeleteBackupRequest } from '@velero-agent/velero';
...
export class DeleteBackupRequestController extends K8sCustomObjectController<V1DeleteBackupRequest> {
