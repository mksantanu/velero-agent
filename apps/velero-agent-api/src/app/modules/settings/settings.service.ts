...
import { AddVeleroPluginDTO } from '@velero-agent-api/shared/dto/settings.dto';
import { Socket } from 'socket.io';
import { ConfigService } from '@nestjs/config';
import { Writable } from 'stream';
import { VELERO } from '@velero-agent-api/shared/modules/velero/velero.constants';
import { K8S_CONNECTION } from '@velero-agent-api/shared/utils/k8s.utils';
import { VeleroService } from '@velero-agent-api/shared/modules/velero/velero.service';
import { ServerStatusRequestService } from '@velero-agent-api/modules/server-status-request/server-status-request.service';
import { V1PluginInfo, V1ServerStatusRequest } from '@velero-agent/velero';
import { AppLogger } from "@velero-agent-api/shared/modules/logger/logger.service";
import {
  parseVeleroLog,
  parseVeleroUILog,
} from '@velero-agent-api/shared/utils/logs.utils';
