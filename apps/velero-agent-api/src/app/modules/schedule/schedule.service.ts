...
import {
  CreateScheduleDto,
  EditScheduleDto,
} from '@velero-agent-api/shared/dto/schedule.dto';
...
} from '@velero-agent-api/modules/k8s-custom-object/k8s-custom-object.utils';
...
import { BackupService } from '@velero-agent-api/modules/backup/backup.service';
