...
import { Resources, V1BackupRepository } from '@velero-agent/velero';
...
export class BackupRepositoryController extends K8sCustomObjectController<V1BackupRepository> {
