...
import RestoreFormFromBackup from '@velero-agent-app/components/Restore/forms/RestoreFormFromBackup.vue';
import RestoreFormInfo from '@velero-agent-app/components/Restore/forms/RestoreFormInfo.vue';
import RestoreFormResources from '@velero-agent-app/components/Restore/forms/RestoreFormResources.vue';
import RestoreFormConfig from '@velero-agent-app/components/Restore/forms/RestoreFormConfig.vue';
import RestoreFormConfirm from '@velero-agent-app/components/Restore/forms/RestoreFormConfirm.vue';
