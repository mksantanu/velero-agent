    ...
    <ul class="space-y-4 mb-4">
      <li>
        <input
          ...
          :value="CreateBackupTypeEnum.FROM_SCHEDULE"
          class="hidden peer"
          name="type"
          required
          type="radio"
      ...
      <li>
        <input
          id="custom"
          v-model="currentForm.type"
          :value="CreateBackupTypeEnum.FROM_SCRATCH"
          class="hidden peer"
          name="type"
          type="radio"
        >
        ...
        >
          <div class="block">
            <div class="text-lg font-semibold">
              {{ t('form.field.fromScratch') }}
            </div>
            <div class="text-gray-500 dark:text-gray-400">
              {{ t('form.hint.fromScratch') }}
            </div>
          </div>
          <FontAwesomeIcon
            :icon="faArrowRightLong"
...
import { CreateBackupTypeEnum } from '@velero-agent/shared-types';
