...
import BackupCreateType from '@velero-agent-app/components/Backup/forms/BackupFormType.vue';
import BackupCreateInfo from '@velero-agent-app/components/Backup/forms/BackupFormInfo.vue';
import BackupCreateConfirm from '@velero-agent-app/components/Backup/forms/BackupFormConfirm.vue';
...
import { Resources, type V1BackupSpec } from '@velero-agent/velero';
import BackupCreateTemplate from '@velero-agent-app/components/Backup/forms/BackupFormSchedule.vue';
