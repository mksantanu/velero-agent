...
import type { V1BackupRepositorySpec } from '@velero-agent/velero';
import { V1BackupRepositoryType } from '@velero-agent/velero';
import {
...
import ResourceDetails from '@velero-agent-app/components/Resource/ResourceDetails.vue';
