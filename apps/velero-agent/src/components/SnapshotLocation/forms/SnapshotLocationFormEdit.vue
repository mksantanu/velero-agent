...
import SnapshotLocationFormCreateInfo from '@velero-agent-app/components/SnapshotLocation/forms/SnapshotLocationFormInfo.vue';
import SnapshotLocationFormCreateCredential from '@velero-agent-app/components/SnapshotLocation/forms/SnapshotLocationFormCredential.vue';
import SnapshotLocationFormCreateConfirm from '@velero-agent-app/components/SnapshotLocation/forms/SnapshotLocationFormConfirm.vue';
