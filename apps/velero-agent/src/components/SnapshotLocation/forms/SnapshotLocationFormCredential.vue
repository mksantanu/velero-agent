    ...
    <div class="space-y-4 mb-4">
      ...
      >
        ...
        <div>
          ...
          <a
            href="https://velero.io/docs/latest/locations/#create-a-volume-snapshot-location-that-uses-unique-credentials"
            target="_blank"
          >
            <button
...
import { useFormSecrets } from '@velero-agent-app/composables/form/useFormSecrets';
