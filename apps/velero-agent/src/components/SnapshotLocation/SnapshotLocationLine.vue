<template>
  ...
  >
    <div class="flex items-center">
      ...
      />
      <div
        v-if="data?.status?.phase === V1VolumeSnapshotLocationPhase.Unavailable"
...
import SnapshotLocationFormEdit from '@velero-agent-app/components/SnapshotLocation/forms/SnapshotLocationFormEdit.vue';
