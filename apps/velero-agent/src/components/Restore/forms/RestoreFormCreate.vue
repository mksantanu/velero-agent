...
} from '@velero-agent/shared-types';
import { onBeforeUnmount, shallowRef, watch } from 'vue';
import { useKubernetesCreateObject } from '@velero-agent-app/composables/useKubernetesCreateObject';
import { Resources, type V1RestoreSpec } from '@velero-agent/velero';
import RestoreFormCreateFromSchedule from '@velero-agent-app/components/Restore/forms/RestoreFormFromSchedule.vue';
import RestoreFormCreateFromBackup from '@velero-agent-app/components/Restore/forms/RestoreFormFromBackup.vue';
import RestoreFormType from '@velero-agent-app/components/Restore/forms/RestoreFormType.vue';
import RestoreFormCreateInfo from '@velero-agent-app/components/Restore/forms/RestoreFormInfo.vue';
import RestoreFormCreateResources from '@velero-agent-app/components/Restore/forms/RestoreFormResources.vue';
import RestoreFormCreateConfig from '@velero-agent-app/components/Restore/forms/RestoreFormConfig.vue';
import RestoreFormCreateConfirm from '@velero-agent-app/components/Restore/forms/RestoreFormConfirm.vue';
