...
import { Resources, type V1Restore } from '@velero-agent/velero';
...
import RestoreStatusPhaseBadge from '@velero-agent-app/components/Restore/RestoreStatusPhaseBadge.vue';
