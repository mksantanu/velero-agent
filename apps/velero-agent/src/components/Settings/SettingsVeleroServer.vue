<template>
  ...
  >
    ...
    >
      ...
      <div v-if="data?.connected" class="inline-flex items-center">
        <button
...
import { useSettingsServer } from '@velero-agent-app/composables/settings/useSettingsServer';
import { useI18n } from 'vue-i18n';
import type { SocketIO } from '@velero-agent-app/plugins/socket.plugin';
import Skeleton from '@velero-agent-app/components/Skeleton.vue';
import { LogType } from '@velero-agent/shared-types';
import ModalLogs from '@velero-agent-app/components/Modals/ModalLogs.vue';
