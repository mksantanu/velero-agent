...
import StorageLocationLine from '@velero-agent-app/components/StorageLocation/StorageLocationLine.vue';
import {
  faExclamationCircle,
  faPlus,
  faTrashCan,
...
import StorageLocationCreate from '@velero-agent-app/components/StorageLocation/forms/StorageLocationFormCreate.vue';
