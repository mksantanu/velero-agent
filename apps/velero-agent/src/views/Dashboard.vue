...
import DashboardBasicStats from '@velero-agent-app/components/Dashboard/DashboardBasicStats.vue';
import DashboardBackupsStatusStats from '@velero-agent-app/components/Dashboard/DashboardBackupsStatusStats.vue';
import DashboardBackupsSuccessRateStats from '@velero-agent-app/components/Dashboard/DashboardBackupsSuccessRateStats.vue';
import DashboardRestoresStatusStats from '@velero-agent-app/components/Dashboard/DashboardRestoresStatusStats.vue';
import DashboardRestoresSuccessRateStats from '@velero-agent-app/components/Dashboard/DashboardRestoresSuccessRateStats.vue';
import { inject } from 'vue';
import { Action, type AppConfig } from '@velero-agent/shared-types';
import { useI18n } from 'vue-i18n';
import { Resources } from '@velero-agent/velero';
import { can } from '@velero-agent-app/utils/policy.utils';
import DashboardUnscheduledNamespaces from '@velero-agent-app/components/Dashboard/DashboardUnscheduledNamespaces.vue';
import DashboardBackupsNextScheduled from "@velero-agent-app/components/Dashboard/DashboardBackupsNextScheduled.vue";
import DashboardBackupsLatest from "@velero-agent-app/components/Dashboard/DashboardBackupsLatest.vue";
