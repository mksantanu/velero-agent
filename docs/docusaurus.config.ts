...
const config: Config = {
  ...
  url: 'https://velero-agent.docs.otwld.com',
  ...
  projectName: 'velero-agent', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/otwld/velero-agent/blob/main',
        },
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/otwld/velero-agent',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Release Note',
              to: 'https://github.com/otwld/velero-agent/releases',
            },
            {
              label: 'Velero',
              to: 'https://velero.io/',
