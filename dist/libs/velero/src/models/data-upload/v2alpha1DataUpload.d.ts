...
import { NodeOS, V1DataMoveOperationProgress, V1Metadata } from '@velero-agent/velero';
...
export declare enum V2alpha1DataUploadSnapshotType {
    CSI = "CSI"
}
...
export declare enum V2alpha1DataUploadPhase {
    New = "New",
    Accepted = "Accepted",
    Prepared = "Prepared",
